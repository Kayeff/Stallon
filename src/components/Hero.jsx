...
export default function Hero() {
  return (
    <div className="w-[90%] font-clash-grotesk">
      <div className="w-full grid grid-cols-2 gap-10">
        <div className="flex items-start justify-start flex-col text-platinium">
            ...
            <div className="flex items-end justify-start flex-col cursor-default">
              ...
              <div className="w-full">
                <p className="font-medium text-lg">
                  From strength training and functional workouts to cardio and
                  group sessions, we have everything you need to transform your
                  body and mind. Take the first step towards a healthier and
                  stronger you!
                </p>
              </div>
            </div>
